...
#NB as of 2024 the download.file util in base R is not working correctly. The TIF files from Bermen are corrupted on download. When I download the files manually via a web browser they are fine. Need to trouble shoot.

# NB Curl not downloading geotifs correctly as of 20231120, commented out download code with ###*** and saved files from web manually for now
# got packages?
